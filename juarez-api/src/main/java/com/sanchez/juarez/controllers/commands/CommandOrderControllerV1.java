...
import com.sanchez.juarez.application.use_cases.order.CancelOrderUseCase;
import com.sanchez.juarez.application.use_cases.order.CreateOrderUseCase;
import com.sanchez.juarez.application.use_cases.order.UpdateOrderStatusUseCase;
...
public class CommandOrderControllerV1 {
    ...
    private static final Logger log = LoggerFactory.getLogger(CommandOrderControllerV1.class);
    private final CreateOrderUseCase createOrderUseCase;
    private final UpdateOrderStatusUseCase updateOrderStatusUseCase;
    private final CancelOrderUseCase cancelOrderUseCase;

    public CommandOrderControllerV1(CreateOrderUseCase createOrderUseCase,
