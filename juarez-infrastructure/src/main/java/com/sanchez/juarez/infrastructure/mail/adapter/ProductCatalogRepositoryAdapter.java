...
public class ProductCatalogRepositoryAdapter implements ProductCatalogRepositoryPort {
    ...
    public ProductCatalogRepositoryAdapter(ProductInCatalogRepository productInCatalogRepository, ProductCatalogMapper productCatalogMapper, CacheManager cacheManager) {
